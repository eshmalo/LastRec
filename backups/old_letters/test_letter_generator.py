#!/usr/bin/env python3
"""
Test script for letter_generator.py.
This directly tests the letter generation functionality.
"""
...
from letter_generator import generate_tenant_letter, compile_to_pdf
...
def main():
    print("Testing letter generator...")
    ...
    # Generate letter with debug mode on
    print("\nGenerating sample letter...")
    
    # Temporarily modify the LETTERS_DIR to use our test directory
